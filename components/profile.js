            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-9">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td scope="col-2">Birth:</td>
                                <td scope="col-10">NOV 1995</td>
                            </tr>
                            <tr>
                                <td scope="col-2">Birthplace:</td>
                                <td scope="col-10">Japan, Chiba, Sakura City</td>
                            </tr>
                            <tr>
                                <td scope="col-2">Interest:</td>
                                <td scope="col-10">watching football games, traveling, playing games and engineering</td>
                            </tr>
                            <tr>
